export default function handler(req, res) {
  ...
  <text x="180" y="387" text-anchor="middle" font-family="Arial, sans-serif" font-size="11" font-weight="700" fill="#fcd34d" letter-spacing="1">AULA EXCLUSIVA</text>
  ...
  <!-- Subtitle -->
  <text x="620" y="240" font-family="Arial, sans-serif" font-size="16" fill="#8aaeaf" font-weight="400">Aula exclusiva e presencial</text>
